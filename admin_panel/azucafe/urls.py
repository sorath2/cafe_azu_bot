...
from .views import cafe_list, cafe_detail, cafe_seats, cancel_reservation
from .views_booking import booking_create, booking_update
from .views_payments import payment_result, payment_success, payment_fail

app_name = 'azucafe'

urlpatterns = [
    path('azucafe/cancel_reservation/<int:reservation_id>/', cancel_reservation, name='cancel_reservation'),
    path('azucafe/profile/', cafe_list, name='cafe_list'),
    path('azucafe/cafe_detail/<int:cafe_id>/', cafe_detail, name='cafe_detail'),
